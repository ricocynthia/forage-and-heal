...
- Search by name or healing property (e.g. "immune", "sleep", "liver")
- Filter by category: Plants or Mushrooms
- Card grid with key properties and season at a glance
- Click any card for full details including:
  - How to identify
  - How to harvest
  - How to store
  - Health benefits
